...
public class Protocol {
    ...
    public static final int FILE_NOT_MODIFIED_CODE = 304;
    public static final String FILE_NOT_MODIFIED_TEXT = "File Not Modified";
    ...
    // useful HEAD elements in response
    ...
    public static final String AUTHOR = "Charlie Horton, Lexi Harris, Isaiah Smith, Jon Kurian";
    public static final String CLOSE = "Close";
    public static final String OPEN = "Keep-Alive";
    public static final String DEFAULT_FILE = "index.html";
    public static final String MIME_TEXT = "text";
	public static final int DEFAULT_URI_LENGTH = 0;
